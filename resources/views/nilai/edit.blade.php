...
@section('content')
    <div class="container-form">
        ...
        <form action="/nilai/update/{{ $idKelas }}/{{ $nilai->id }}" method="post">
            ...
            <input type="number" name="uh" min="0" max="100" value="{{ $nilai->uh }}">

            <label for="uts">UTS</label>
            <input type="number" name="uts" min="0" max="100" value="{{ $nilai->uts }}">

            <label for="uas">UAS</label>
            <input type="number" name="uas" min="0" max="100" value="{{ $nilai->uas }}">
